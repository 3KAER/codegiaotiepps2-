...
void setup(){
  ...
  error = ps2x.config_gamepad(PB12,PB13,PB14,PB15, false, false);   //setup pins and settings:  GamePad(clock, command, attention, data, Pressures?, Rumble?) check for error
